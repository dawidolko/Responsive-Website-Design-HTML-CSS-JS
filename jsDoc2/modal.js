/**
 * Pobiera element produktu o konkretnym indeksie i wyświetla go w modalnym oknie.
 * @param {Object} item - Obiekt reprezentujący produkt.
 */
function showMenuItems(item) {
    ...
    // Wyświetl modal z danymi produktu
    ...
    // Pobierz przycisk zamykania i dodaj obsługę zdarzeń
    ...
    // Obsługa powiększenia obrazka przy najechaniu myszką
...
// Pobierz przyciski "View" dla produktów
const productView = document.querySelectorAll(".shoes__btn-view");

// Dodaj obsługę zdarzenia kliknięcia do przycisków "View"
productView.forEach((image, index) => {
    image.addEventListener("click", () => {
        if (index < modalProduct.length) {
            // Wywołaj funkcję showMenuItems z danymi produktu
